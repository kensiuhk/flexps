...
std::vector<float> DataLoader::get_class_vect() { return this->class_vect; }

std::vector<std::vector<float>> DataLoader::get_feat_vect_list() { return this->feat_vect_list; }
...
void DataLoader::split_dataset_by_feat_val(int feat_id, float split_val, std::vector<float>& orig_grad_vect,
                                           std::vector<float>& left_grad_vect, std::vector<float>& right_grad_vect,
                                           std::vector<float>& orig_hess_vect, std::vector<float>& left_hess_vect,
